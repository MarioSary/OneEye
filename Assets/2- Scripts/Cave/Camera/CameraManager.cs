...
public class CameraManager : MonoBehaviour
{
    ...
    [SerializeField] private float fallYPanTime = 035f;
    ...
    private void Awake()
    {
        ...
        //set Y damonig amount so it's based on the inspector value
    ...
    {
        // if the current camera is on the left and the trigger exit direction is on the right
        ...
        // if the current camera is on the right and the trigger exit direction is on the left
